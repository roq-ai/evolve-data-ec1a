...
import { getSpaceById } from 'apiSdk/spaces';
import { SpaceInterface } from 'interfaces/space';
import { DataSourceListPage } from 'pages/data-sources';
import { UserSpaceListPage } from 'pages/user-spaces';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('space', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/spaces/edit/${id}`} passHref legacyBehavior>
                    <Button
