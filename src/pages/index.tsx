...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Evolve Data`}</title>

        <meta
          name="description"
          content="Evolve Data: Your Collaborative Analytics Platform. Unleash the Power of Data Across all Business Segments with Role-Based Permissions and Integrations. Making Business Intelligence Easy and Accessible."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1460925895917-afdab827c52f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXRhJTIwYW5hbHl0aWNzfGVufDB8fHx8MTY5NDUwNzY3MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Evolve Data: Your Collaborative Analytics Platform. Unleash the Power of Data Across all Business Segments with Role-Based Permissions and Integrations. Making Business Intelligence Easy and Accessible.`}
            </Text>
            <Box
